...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/ink-graph"><img src="https://img.shields.io/npm/v/ink-graph.svg" alt="npm 版本"></a>
  <a href="https://www.npmjs.com/package/ink-graph"><img src="https://img.shields.io/npm/dm/ink-graph.svg" alt="npm 下载量"></a>
...
<p align="center">
  <a href="https://www.npmjs.com/package/ink-graph"><b>📦 npm 包</b></a> &nbsp;|&nbsp;
...
```bash
git clone https://github.com/qaz1230sp/ink-graph.git ~/ink-graph
# 把 SKILL.md 路径加到 Cursor 的 custom instructions 或 rules
```
